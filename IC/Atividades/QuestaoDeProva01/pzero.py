def progressao_aritimetica(primeiro_termo, segundo_termo, terceiro_termo):
    ...
    if (
        ...
        or ((terceiro_termo - primeiro_termo) == segundo_termo)
        or ((segundo_termo - primeiro_termo) == terceiro_termo)
        or ((primeiro_termo - terceiro_termo) == segundo_termo)
        or ((terceiro_termo - segundo_termo) == primeiro_termo)
        or ((segundo_termo - terceiro_termo) == primeiro_termo)
    ):
        return True
    else:
        return False
