...
def assessment_06(debugger=False):
    ...
    cm = f"./{path}out.n 1 ./{path}{file_name}/files/kid"

    execute_command(cm, f"{path}{file_name}/input/kid.in", f"{path}out_resul", timeout=3600)
